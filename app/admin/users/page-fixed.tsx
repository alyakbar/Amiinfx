...
import { 
  Users, UserPlus, Search, Filter, Download, Eye, Edit, Trash2, Mail, Phone, 
...
export default function UsersPage() {
  ...
  const userStats = [
    { date: '2024-08-19', total: 245, active: 220, new: 15 },
    { date: '2024-08-20', total: 252, active: 225, new: 18 },
    { date: '2024-08-21', total: 268, active: 240, new: 22 },
    { date: '2024-08-22', total: 275, active: 248, new: 20 },
    { date: '2024-08-23', total: 289, active: 260, new: 25 }
  ];

  const roleDistribution = [
    { name: 'Users', value: 85, color: '#3B82F6', count: 245 },
    { name: 'Admins', value: 10, color: '#10B981', count: 28 },
    { name: 'Moderators', value: 5, color: '#F59E0B', count: 16 }
  ];

  const statusDistribution = [
    { name: 'Active', value: 78, color: '#10B981', count: 225 },
    { name: 'Inactive', value: 15, color: '#6B7280', count: 43 },
    { name: 'Suspended', value: 7, color: '#EF4444', count: 21 }
  ];
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      toast({
        title: "Users loaded",
        description: `Found ${sampleUsers.length} users.`,
      });
    } catch (error) {
